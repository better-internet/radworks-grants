...
1. **Application**
   ...
   5. Once you're done, create a [patch](https://docs.radicle.xyz/docs/using-radicle/creating-patches). The patch should
      only contain _one new file_, the Markdown file `project_name.md` you created from the template. <!--- RADICLE -->
   ...
   7. Sign off on the [terms and conditions](docs/T&Cs.md)  <!--- TODO -->
2. **Application Review** <!--- FLESH_OUT -->
   1. The [committee](#radicle-grants-committee) will review, add comments where needed, and possibly make change 
      requests.
   2. Clarifications and amendments should be made in a timely manner. If you don't respond within 2 weeks, we may close the application due to inactivity. You're welcome reopen an application from the same patch, assuming it was not rejected.
...
4. **Payment**
   1. <!--- TODO Fill in with Radicle specific details around Funding/Drips, etc.-->


If you have a contribution that is not technical in nature, please feel free to apply via our non-technical application
below:
